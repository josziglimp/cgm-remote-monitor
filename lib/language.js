...
function init() {
  ...
  var translations = {
    ...
    ,'Use carbs correction in calculation' : {
      ...
      ,nb: 'Bruk karbohydratkorering i beregning'
    ...
    ,'Urgent' : {
      cs:'Urgentní'
      ,he: 'דחוף '
      ,hu: '⚠️ Nagyon' // A bit slang phrase
      ,de: 'Akut'
      ,dk: 'Akut'
      ,ro: 'Urgent'
      ,fr: 'Urgent'
    ...
    ,'Warning' : {
      cs:'Varování'
      ,he: 'אזהרה '
      ,hu: 'Kicsit ' // Not accurate translation
      ,de: 'Warnung'
      ,dk: 'Advarsel'
      ,ro: 'Atenție'
      ,fr: 'Attention'
    ...
    ,'Cannula change overdue!' : {
      ...
      ,hu: 'Pumpa csere ideje elmúlt!' // Bit slang phrase
    ...
    ,'Time to change cannula' : {
      ...
      ,hu: 'Itt az ideje a pumpa cserének!' //  Bit slang phrase
    ...
    ,'Change cannula soon' : {
      ...
      ,he: 'החלף קנולה בקרוב '
      ,hu: 'Hamarosan cseréld ki a pumpát!' // Bit slang phrase
   ...
   ,'Last Carbs' : {
    ...
    ,'Stale data, check rig?' : {
      ...
      ,hu: 'Nincs szenzor adat. Neked van? BluCon rendben? ❓'
    ...
    ,'Sensor age %1 days %2 hours' : {  // *** óra nap+órára váltva
